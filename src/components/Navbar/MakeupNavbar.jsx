...
// // El codigo oculta mi perfil usuario y el perfil administrador
// import React, { useContext, useState, useEffect } from 'react';
// import { NavLink } from 'react-router-dom';
// import { Container, Dropdown } from 'react-bootstrap';
// import makeupImage from '../../img/Logo.png';
...
// export default function MakeupNavbar({ onCategoryChange, perfilImage }) {
//     const { calculateTotalPrice, cart, loggedIn, isAdmin } = useContext(AppContext);
//     const [menuCategories, setMenuCategories] = useState([]);
//     const [error, setError] = useState(null);
...
// export default function MakeupNavbar({ onCategoryChange, perfilImage }) {
//     const { calculateTotalPrice, cart, loggedIn } = useContext(AppContext);
//     const [menuCategories, setMenuCategories] = useState([]);
//     const [error, setError] = useState(null);
...
export default function MakeupNavbar({ onCategoryChange, perfilImage, usuario }) {
    const { calculateTotalPrice, cart, loggedIn } = useContext(AppContext);
    const [menuCategories, setMenuCategories] = useState([]);
    const [error, setError] = useState(null);
